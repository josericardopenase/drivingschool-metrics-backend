...
from administrative_management.application.theory_grade_checker import TheoryGradeCheckerInterface, GradeResponse


class DGTGradeChecker(TheoryGradeCheckerInterface):
    def __init__(self):
    ...
    def fetch_grade(self, DNI: str, fechaExamen: str, clasePermiso: str, nacimiento: str) -> GradeResponse:
        ...
        try:
            ...
            return GradeResponse(calification=calificacion, errors=errores)
